$(function() {
  ...
  $(".wrapper-modal-image .image-content .action-remove").click(function(event) {
  ...
  $(".wrapper-modal-image .image-content .image-controls .modal-ui-icon").click(function(event) {
    event.preventDefault();
