...
class TestViews(TestCase):
    ...
    @patch('class_dashboard.dashboard_data.get_d3_problem_grade_distrib')
    ...
    @patch('class_dashboard.dashboard_data.get_d3_sequential_open_distrib')
    @patch('class_dashboard.views.has_instructor_access_for_class')
    ...
    @patch('class_dashboard.dashboard_data.get_d3_section_grade_distrib')
    @patch('class_dashboard.views.has_instructor_access_for_class')
